            ...
            >
              ...
              {index === 0 ? (
                <div
                  ...
                  } relative h-96 rounded-xl overflow-hidden flex items-center justify-center`}
                >
                  <img 
                    src="/app_dev.png" 
                    alt="Smart Home Hub Application"
                ...
                >
                  ...
                  <p className="text-gray-400 text-center text-sm max-w-md mb-8 leading-relaxed">
                    Weather you want help in customer handling or make changes
                    in your system just give me command
                  </p>
                ...
                >
                  ...
                  <div className="bg-zinc-900/50 rounded-xl p-4 border border-zinc-800">
                    ...
                    <div className="flex gap-2 mb-4">
                      ...
                      <span className="px-3 py-1.5 rounded-lg bg-zinc-800 text-gray-400 text-xs">
                        Tu
                      </span>
                      <span className="px-3 py-1.5 rounded-lg bg-zinc-800 text-gray-400 text-xs">
                        We
